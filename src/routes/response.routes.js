...
import { exportIndividualReportExcel, exportOrganizationReportExcel } from "../controllers/response.controller.js";
...
router.get("/organization/:orgName/export", flexibleProtect, exportOrganizationReportExcel);
